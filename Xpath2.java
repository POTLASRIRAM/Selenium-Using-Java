...
public class Xpath2 {
	...
	public static void main(String[] args) throws Exception {
		...
		//Checking the returns and orders using xpath functions, operators and multiple attributes
		driver.findElement(By.xpath("//span[text()='Returns']")).click();
		System.out.println("Entered into Returns and orders page...");
		Thread.sleep(1000);
		
		//Checking holiday deals by using some part of text
		driver.findElement(By.xpath("//a[starts-with(text(),'Holiday')]")).click();
		System.out.println("Entered into holiday deals...");
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//a[normalize-space()='Amazon Basics']")).click();
		driver.quit();
